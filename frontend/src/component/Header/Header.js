    ...
    <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
      ...
      <div className="flex">
        <div className="flex items-center">
          <i>Search icon</i>
        <input placeholder="검색어를 입력해주세요" className="bg-white focus:outline-none focus:shadow-outline border border-yellow-300 rounded-lg py-1 px-4 block mx-4 appearance-none leading-normal"></input>
        </div>
